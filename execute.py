...
def logo():
	os.system('clear')
	auth=m+'  Author : '+k+'./Omar | Modified By: github.com/XxxOM4RTEAMxxX'
	# DISCLAMER WE ARE DON T CARE WHATS WILL HAPPEN THAT TOOL FOR FUN %s YT:https://youtube.com/channel/UCOPvhnYsBvSjsySNl1Hf_Qg, %d = Discord:am not fachist i lve mussolinie#7378 , %i = Donate me!
	return '''
 ░░░░░░░░░░░░▄▄▄█████████▄▄▄░░░░░░░░░░░░
░░░░░░░░▄▄██████▀▀▀▀▀▀▀██████▄▄░░░░░░░░
░░░░░░▄████▀▀░░░░░░░░░░░░░▀▀████▄░░░░░░
...
def main():
	...
	if( pil == '1' or pil == '01'):
		...
		print(m+'             Don't forgot leaving a blank')
		time.sleep(2)
		main()
def jnspam():
	global jns
	print(logo())
	print(b+'ooooooooooooooooooooooooooooooooooooooooooo\n'+b+'║'+h+'〘 '+m+'SPAM '+h+'〙\n'+b+'╠══════════════════════════════'+b+'\n║'+m+'『'+h+'▣'+m+'』'+bm+' Exit\n'+b+'╠══════════════════════════════'+b+'\n║'+m+'『'+h+'1'+m+'』 '+bm+'All\n'+b+'║'+m+'『'+h+'2'+m+'』 '+bm+'PHD\n'+b+'║'+m+'『'+h+'3'+m+'』 '+bm+'KitaBisa\n'+b+'║'+m+'『'+h+'4'+m+'』 '+bm+'Tokopedia\n'+b+'║'+m+'『'+h+'5'+m+'』 '+bm+'TokoTalk (infinite)\n'+b+'║'+m+'『'+h+'6'+m+'』 '+bm+'Balaji (Without +62 or 0)\n'+b+'╠══════════════════════════════')
	while True:
